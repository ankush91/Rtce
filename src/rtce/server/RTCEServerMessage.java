...
public class RTCEServerMessage {
	...
	// This function builds and transmits the Message on the supplied socket
	public void recvMessage(Socket s, RTCEMessageType request, ByteBuffer bf, ServerLog log, ServerRecordMgmt record)
	{
		...
		case S_TREQST:
			control = new ControlMessage();
			control.getS_TREQST(bf, s, log, record);
			break;    
...
public void getS_TREQST(ByteBuffer bf, Socket s, ServerLog log, ServerRecordMgmt record)
	{   
		...
		//System.out.println("Options: "+ bf.get());
                    ...
                    System.out.println("section" + section + " " +record.checkFreeSection(section));
